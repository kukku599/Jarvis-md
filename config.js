...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_d341_4b8e_e751_8bfd_c21a_0a4a_6f10_5b79',
  ...
  AUTHOR: process.env.AUTHOR || 'Mᴏɴᴊᴀɴ-Kᴜᴋᴋᴜ',
  MEDIA_DATA: process.env.MEDIA_DATA|| 'Oɴɴ-Pᴏᴅᴀ-Nɪ-Uᴅᴀʏɪᴩᴩᴀ;CʜɪɴɴᴜᴢZᴢ;https://i.imgur.com/2uPq2Si.jpeg',
  SUDO: process.env.SUDO || '918281825858,',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'Nᴊ-Uᴍʙᴀɴ;Mᴏɴᴊᴀɴ-Kᴜᴋᴋᴜ;https://i.imgur.com/VIpl3q5.mp4',
